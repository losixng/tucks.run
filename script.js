...
// === Search Logic ===
const departmentMap = {
  clothes: ["cshirts", "shirts", "trousers"],
    footwear: ["loafers", "slides", "sneakers"],
    gadgets: ["accessoriesGadgets", "laptops", "phones"],
    hairessentials: ["hairProducts"],
    jewelry: ["accessoriesJewelry", "bracelets", "chains","rings","watches"],
    skin: ["skinCare"],
    thrift: ["thrift"]
};
